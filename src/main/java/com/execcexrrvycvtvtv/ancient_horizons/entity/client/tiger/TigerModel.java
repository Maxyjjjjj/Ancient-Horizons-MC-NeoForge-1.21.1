...
public class TigerModel<T extends TigerEntity> extends AgeableListModel<T> {
    ...
    public void setupAnim(TigerEntity entity, float limbSwing, float limbSwingAmount,
        ...
        boolean isAngry = entity.isAggressive();
        ...
        if (isSleeping) {
            ...
            this.body.y = 10.0F;
            this.body.xRot = -0.5236F;

            this.pawleftfront.xRot = 0.7854F;
            this.pawrightfront.xRot = 0.7854F;
            this.pawleftback.xRot = -0.7854F;
            this.pawrightback.xRot = 0.7854F;

            this.pawleftback.y = 1.0F;
            this.pawrightback.y = 1.0F;
            ...
            this.angerfur.visible = true;
            this.angerfur.y = 2.0F;
            this.head.y = -3.0F;
            this.eyesangry.visible = true;
    ...
    private void resetPose() {
        ...
        clawsleftfront.xRot = 0F; clawsleftfront.y = 10F;
        clawsrightfront.xRot = 0F; clawsrightfront.y = 10F;
        clawsleftback.xRot = 0F; clawsleftback.y = 10F;
        clawsrightback.xRot = 0F; clawsrightback.y = 10F;
